...
public class TavoloScala extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if(message.equals("scala40QD")){
            textRinPun = "Punteggio";
        }else{
            textRinPun = "Rientro";
        }
        rientri.setText(textRinPun);
	}
...
/** Called when the user clicks the play button */
	public void play(View v) {
        ...
        if (valueP.equals("") || valueR.equals("") || numPlayers < 2) {
            ...
            alertDialogBuilder
                .setMessage("Inserire il valore della Puntata e del " + textRinPun +" e selezionare almeno due giocatori")
                .setCancelable(false)
            ...
            if(message.equals("scala40")){
                intent = new Intent(this, PartitaScala.class);
            }else{
                intent = new Intent(this, PartitaScala40QD.class);
            }
