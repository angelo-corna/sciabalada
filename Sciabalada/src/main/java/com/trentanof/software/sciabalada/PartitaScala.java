...
public class PartitaScala extends Activity {
	...
	Player pl3 = new Player(0,"dummy",3,false);
	Player pl4 = new Player(0,"dummy",4,false);
	Player pl5 = new Player(0,"dummy",5,false);
	Player pl6 = new Player(0,"dummy",6,false);
	Player pl7 = new Player(0,"dummy",7,false);
	Player pl8 = new Player(0,"dummy",8,false);
	Player pl9 = new Player(0,"dummy",9,false);
	Player pl10 = new Player(0,"dummy",10,false);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_partita_scala);
		...
		for (int i=0; i < numPlayers; i++) {
 			numReenters = numReenters + effectivePl[i].getReenter();
		}
	...
	*/
	...
	public void UpdatePlayerScore(Player pl){
		 ...
		 if(plselected.getIsOut() == false){
			 ...
			 if(pl.getScore()> 300){
				 alertDialogBuilder.setTitle(plselected.getName()+" e' fuori");
				 ...
				 alertDialogBuilder.setNeutralButton("Non Rientra",
				            new DialogInterface.OnClickListener() {
				                public void onClick(DialogInterface dialog, int id) {
				                	plselected.setIsOut(true);
				...
				boolean chkRientra = true;
     			for (int i=0; i < numPlayers; i++) {
    				if (effectivePl[i] != plselected & effectivePl[i].getGames() != plselected.getGames() & effectivePl[i].getIsOut() == false){chkRientra = false;}}
					            ...
					            new DialogInterface.OnClickListener() {
					                public void onClick(DialogInterface dialog, int id) {
										...
										int valueReenter = 0;
					         			...
					         			plselected.setScore(valueReenter);
					         			plselected.setReenter(plselected.getReenter()+1);
					         			numReenters=0;
					         			for (int i=0; i < numPlayers; i++) {
					         				numReenters = numReenters + effectivePl[i].getReenter();
					        			}
				 ...
				 final EditText textBox = new EditText(PartitaScala.this);
	...
	public void DisplayPlayerData(Player pl){
		...
		switch (rank) {
	        case 1: TextView pl1Name = (TextView) findViewById(R.id.player1);
	        		...
	        		TextView pl1Reenter = (TextView) findViewById(R.id.reenter1);
	        		...
	        		if (pl1.getName().equals("dummy")){
	        			...
	        			pl1Reenter.setVisibility(TextView.GONE);
	        		}else{
		        		pl1Name.setText(pl.getName());;
		        		scoreText1.setText("" + pl.getScore());		
		        		scoreBar1.setProgress(pl.getScore());
	        			pl1Games.setText("" + pl.getGames());
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl1Reenter.setTextColor(Color.RED);}
	        			pl1Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl1Name.setTextColor(Color.RED);
		        			scoreText1.setTextColor(Color.RED);
		        			scoreText1.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl1Name.setTextColor(Color.GRAY);
		        			scoreText1.setTextColor(Color.GRAY);
            				imgGames1.setBackgroundColor(Color.GRAY);
            				pl1Reenter.setTextColor(Color.GRAY);
		        			...
		        			pl1Name.setTextColor(Color.BLACK);
		        			scoreText1.setTextColor(Color.BLACK);
		        			scoreText1.clearAnimation();
		        		}
	        		}
	        		break;
	        case 2: TextView pl2Name = (TextView) findViewById(R.id.player2);
	        		...
	        		TextView pl2Reenter = (TextView) findViewById(R.id.reenter2);
	        		...
	        		if (pl2.getName().equals("dummy")){
	        			...
	        			pl2Reenter.setVisibility(TextView.GONE);
	        		}else{
	        			...
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl2Reenter.setTextColor(Color.RED);}
	        			pl2Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl2Name.setTextColor(Color.RED);
		        			scoreText2.setTextColor(Color.RED);
            				...
            				pl2Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar2.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText2.clearAnimation();
		        		}else{
		        			pl2Name.setTextColor(Color.BLACK);
		        			scoreText2.setTextColor(Color.BLACK);
		        			scoreText2.clearAnimation();
		        		}
	        		}
	        		break;
	        case 3: TextView pl3Name = (TextView) findViewById(R.id.player3);
	        		...
	        		TextView pl3Reenter = (TextView) findViewById(R.id.reenter3);
	        		...
	        		if (pl3.getName().equals("dummy")){
	        			...
	        			pl3Reenter.setVisibility(TextView.GONE);
	        		}else{
	        			...
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl3Reenter.setTextColor(Color.RED);}
	        			pl3Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl3Name.setTextColor(Color.RED);
		        			scoreText3.setTextColor(Color.RED);
		        			scoreText3.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl3Name.setTextColor(Color.GRAY);
		        			scoreText3.setTextColor(Color.GRAY);
            				imgGames3.setBackgroundColor(Color.GRAY);
            				pl3Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar3.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText3.clearAnimation();
		        		}else{
		        			pl3Name.setTextColor(Color.BLACK);
		        			scoreText3.setTextColor(Color.BLACK);
		        			scoreText3.clearAnimation();
		        		}
	        		}	
	        		break;
	        case 4: TextView pl4Name = (TextView) findViewById(R.id.player4);
	        		...
	        		TextView pl4Reenter = (TextView) findViewById(R.id.reenter4);
	        		...
	        		if (pl4.getName().equals("dummy")){
	        			...
	        			pl4Reenter.setVisibility(TextView.GONE);
        		}else{
	        			...
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl4Reenter.setTextColor(Color.RED);}
	        			pl4Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl4Name.setTextColor(Color.RED);
		        			scoreText4.setTextColor(Color.RED);
		        			scoreText4.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl4Name.setTextColor(Color.GRAY);
		        			scoreText4.setTextColor(Color.GRAY);
            				imgGames4.setBackgroundColor(Color.GRAY);
            				pl4Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar4.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText4.clearAnimation();
		        		}else{
		        			pl4Name.setTextColor(Color.BLACK);
		        			scoreText4.setTextColor(Color.BLACK);
		        			scoreText4.clearAnimation();
		        		}
	        		}
		            break;
	        case 5: TextView pl5Name = (TextView) findViewById(R.id.player5);
	        		...
	        		TextView pl5Reenter = (TextView) findViewById(R.id.reenter5);
	        		...
	        		if (pl5.getName().equals("dummy")){
	        			...
	        			pl5Reenter.setVisibility(TextView.GONE);
	        		}else{
	        			...
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl5Reenter.setTextColor(Color.RED);}
	        			pl5Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl5Name.setTextColor(Color.RED);
		        			scoreText5.setTextColor(Color.RED);
		        			scoreText5.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl5Name.setTextColor(Color.GRAY);
		        			scoreText5.setTextColor(Color.GRAY);
            				imgGames5.setBackgroundColor(Color.GRAY);
            				pl5Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar5.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText5.clearAnimation();
		        			
		        		}else{
		        			pl5Name.setTextColor(Color.BLACK);
		        			scoreText5.setTextColor(Color.BLACK);
		        			scoreText5.clearAnimation();
		        		}
	        		}
	        		break;
	        case 6: TextView pl6Name = (TextView) findViewById(R.id.player6);
	        		...
	        		TextView pl6Reenter = (TextView) findViewById(R.id.reenter6);
	        		...
	        		if (pl6.getName().equals("dummy")){
	        			...
	        			pl6Reenter.setVisibility(TextView.GONE);
	        		}else{
	        			...
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl6Reenter.setTextColor(Color.RED);}
	        			pl6Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl6Name.setTextColor(Color.RED);
		        			scoreText6.setTextColor(Color.RED);
		        			scoreText6.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl6Name.setTextColor(Color.GRAY);
		        			scoreText6.setTextColor(Color.GRAY);
            				imgGames6.setBackgroundColor(Color.GRAY);
            				pl6Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar6.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText6.clearAnimation();
		        		}else{
		        			pl6Name.setTextColor(Color.BLACK);
		        			scoreText6.setTextColor(Color.BLACK);
		        			scoreText6.clearAnimation();
		        		}
	        		}
	        		break;
	        case 7: TextView pl7Name = (TextView) findViewById(R.id.player7);
	        		...
	        		TextView pl7Reenter = (TextView) findViewById(R.id.reenter7);
	        		...
	        		if (pl7.getName().equals("dummy")){
	        			...
	        			pl7Reenter.setVisibility(TextView.GONE);
	        		}else{
						pl7Name.setText(pl.getName());;
			    		scoreText7.setText("" + pl.getScore());		
			    		scoreBar7.setProgress(pl.getScore());
	        			pl7Games.setText("" + pl.getGames());
	        			pl7Reenter.setText("" + pl.getReenter());
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl7Reenter.setTextColor(Color.RED);}
	        			pl7Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl7Name.setTextColor(Color.RED);
		        			scoreText7.setTextColor(Color.RED);
		        			scoreText7.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl7Name.setTextColor(Color.GRAY);
		        			scoreText7.setTextColor(Color.GRAY);
            				imgGames7.setBackgroundColor(Color.GRAY);
            				pl7Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar7.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText7.clearAnimation();
		        		}else{
		        			pl7Name.setTextColor(Color.BLACK);
		        			scoreText7.setTextColor(Color.BLACK);
		        			scoreText7.clearAnimation();
		        		}
	        		}
	        		break;
	        case 8: TextView pl8Name = (TextView) findViewById(R.id.player8);
	        		...
	        		TextView pl8Reenter = (TextView) findViewById(R.id.reenter8);
	        		...
	        		if (pl8.getName().equals("dummy")){
	        			...
	        			pl8Reenter.setVisibility(TextView.GONE);
	        		}else{
						pl8Name.setText(pl.getName());;
			    		scoreText8.setText("" + pl.getScore());		
			    		scoreBar8.setProgress(pl.getScore());
	        			pl8Games.setText("" + pl.getGames());
	        			pl8Reenter.setText("" + pl.getReenter());
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl8Reenter.setTextColor(Color.RED);}
	        			pl8Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl8Name.setTextColor(Color.RED);
		        			scoreText8.setTextColor(Color.RED);
		        			scoreText8.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl8Name.setTextColor(Color.GRAY);
		        			scoreText8.setTextColor(Color.GRAY);
            				imgGames8.setBackgroundColor(Color.GRAY);
            				pl8Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar8.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText8.clearAnimation();
		        		}else{
		        			pl8Name.setTextColor(Color.BLACK);
		        			scoreText8.setTextColor(Color.BLACK);
		        			scoreText8.clearAnimation();
		        		}
	        		}
	        		break;
	        case 9: TextView pl9Name = (TextView) findViewById(R.id.player9);
	        		...
	        		TextView pl9Reenter = (TextView) findViewById(R.id.reenter9);
	        		...
	        		if (pl9.getName().equals("dummy")){
	        			...
	        			pl9Reenter.setVisibility(TextView.GONE);
	        		}else{
						pl9Name.setText(pl.getName());;
			    		scoreText9.setText("" + pl.getScore());		
			    		scoreBar9.setProgress(pl.getScore());
	        			pl9Games.setText("" + pl.getGames());
	        			pl9Reenter.setText("" + pl.getReenter());
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl9Reenter.setTextColor(Color.RED);}
	        			pl9Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl9Name.setTextColor(Color.RED);
		        			scoreText9.setTextColor(Color.RED);
		        			scoreText9.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl9Name.setTextColor(Color.GRAY);
		        			scoreText9.setTextColor(Color.GRAY);
            				imgGames9.setBackgroundColor(Color.GRAY);
            				pl9Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar9.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText9.clearAnimation();
		        		}else{
		        			pl9Name.setTextColor(Color.BLACK);
		        			scoreText9.setTextColor(Color.BLACK);
		        			scoreText9.clearAnimation();
		        		}
	        		}
	        		break;
	        case 10: TextView pl10Name = (TextView) findViewById(R.id.player10);
	        		...
	        		TextView pl10Reenter = (TextView) findViewById(R.id.reenter10);
	        		...
	        		if (pl10.getName().equals("dummy")){
	        			...
	        			pl10Reenter.setVisibility(TextView.GONE);
	        		}else{
	        			...
	        			pl10Reenter.setText("" + pl.getReenter());
	        			String showRientri = " rientri";
	        			if (pl.getReenter() == 1){showRientri = " rientro";}
	        			if (pl.getReenter() > 0 ){pl10Reenter.setTextColor(Color.RED);}
	        			pl10Reenter.setText("" + pl.getReenter()+showRientri);
		        		if(pl.getScore() > 300 & pl.getIsOut() == false){
		        			pl10Name.setTextColor(Color.RED);
		        			scoreText10.setTextColor(Color.RED);
		        			scoreText10.startAnimation(anim);
		        		}else if (pl.getIsOut() == true){
		        			pl10Name.setTextColor(Color.GRAY);
		        			scoreText10.setTextColor(Color.GRAY);
            				imgGames10.setBackgroundColor(Color.GRAY);
            				pl10Reenter.setTextColor(Color.GRAY);
            				Drawable drawable = scoreBar10.getProgressDrawable();
            				drawable.setColorFilter(new LightingColorFilter(0xFF000000, 0xFF8c8a8c));
		        			scoreText10.clearAnimation();
		        		}else{
		        			pl10Name.setTextColor(Color.BLACK);
		        			scoreText10.setTextColor(Color.BLACK);
		        			scoreText10.clearAnimation();
		        		}
	        		}
	        		break;
	...
	public void saveFile(String gameType){
		try {
			...
			if(gameType.equals("closed")){
				txtData=txtData+((numPlayers*Float.parseFloat(valueP) + numReenters*Float.parseFloat(valueR))+","+valueP+","+valueR+"\n");
			}else{
				txtData=txtData+valueP+","+valueR+"\n";
			}	
	        ...
	        Toast.makeText(getBaseContext(),
	                "Done writing "+destinationPath+"/"+fileName,
		...
		try {
	        ...
	        txtData+="<h2>Jackpot: "+(numPlayers*Float.parseFloat(valueP) + numReenters*Float.parseFloat(valueR))+" euro<h2><br>";
	        ...
	        for (int b=0; b < numPlayers; b++) {
	    		...
	    		if(effectivePl[b].getIsOut() == true){
	    			...
	    			if(effectivePl[b].getScore() > 300){
	    				txtData+="<td bgcolor=\"#"+bgcolor+"\" valign=\"center\"><h1><font color=\"#FF0000\">"+effectivePl[b].getScore()+"</font color></h1></td>\n";
	    			}else{
	    				txtData+="<td bgcolor=\"#"+bgcolor+"\" valign=\"center\"><h1><font color=\"#"+colorf+"\">"+effectivePl[b].getScore()+" ("+(300-effectivePl[b].getScore())+")</font></h1></td>\n";
	    			}
	    		}
	    		if(effectivePl[b].getReenter() == 1){
		    		txtData+="<td bgcolor=\"#"+bgcolor+"\" valign=\"center\"><h2><font color=\"#"+colorf+"\">"+effectivePl[b].getReenter()+" rientro</font><h2></td>\n";
	    		}else{
		    		txtData+="<td bgcolor=\"#"+bgcolor+"\" valign=\"center\"><h2><font color=\"#"+colorf+"\">"+effectivePl[b].getReenter()+" rientri</font><h2></td>\n";
	    		}
		        txtData+="</tr>\n";
	    	}			
	        txtData+="</table>\n";
